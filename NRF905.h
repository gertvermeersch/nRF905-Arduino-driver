...
public:
	...
	//NRF905(int css);
    void init();
    void write_config(char *conf_buf);
    void write_config(nrf905_freq_type freq_band);
    void write_config_address(char *address);
    void read_config(char *conf_buf);
    void RX(char *TxRxBuffer);
...
private:
    ...
    void TxPacket(char *TxAddress, char *TxRxBuf);
